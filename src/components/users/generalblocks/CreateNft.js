...
class CreateNft extends React.Component {
  ...
  async mint(){
    const client = new NFTStorage({ token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDVjM0MxREExNjEwYTlFNzg5NzYxYzI1NThEOUI5ZjkzRjA4NzBGRDYiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTY1OTc5NzU0OTEzMywibmFtZSI6Im1ldGFib2xpc20ifQ.FkUZG-1NURVn0_OK_2-6YEgfqLBtC8DqdisjNXjyd0o' })
    ...
    const metadataHex = ethers.utils.formatBytes32String(JSON.stringify(metadata));
            ...
            {this.state.gif && (
              <>
                ...
                <div className="cn-left-label">
                  ...
                  <div>
                    <textarea rows="7" cols="30" onChange={(event) =>
